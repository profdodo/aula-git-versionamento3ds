...
feat: adiciona recuperação de senhafeat: adiciona foto de perfil
Correções (Fixes) - PATCH
fix: corrige validação de e-mailfix: corrige botão de login
Melhorias internas
refactor: reorganiza autenticação
Documentação
docs: adiciona instruções de instalação
...
6. Atualizar o CHANGELOG.md - Cria esse arquivo na raiz:
# Changelog
